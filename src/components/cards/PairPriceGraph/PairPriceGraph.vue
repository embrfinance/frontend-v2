  ...
  >
    ...
    >
      <div class="relative h-full bg-transparent p-4">
        ...
        >
          <BalIcon v-if="!isModal" name="maximize-2" class="text-gray-200" />
          <BalIcon v-if="isModal" name="x" class="text-gray-200" />
        </button>
        <div
          v-if="!failedToLoadPriceData && !(isLoadingPriceData || appLoading)"
        >
        ...
        >
          ...
          >
              ...
              <button
                ...
                :class="[
                  'py-1 px-2 text-sm rounded-lg mr-2',
                  {
                    ...
                    'text-gray-200': activeTimespan.value !== timespan.value,
                    'bg-green-400':
                      !isNegativeTrend &&
            ...
            <div :class="{ 'mt-4': isModal }">
              <span class="text-sm text-gray-200 mr-4"
          ...
          <div class="-mt-2 lg:mt-2" v-else>
            <span class="text-sm text-gray-200 w-full flex justify-end">{{
