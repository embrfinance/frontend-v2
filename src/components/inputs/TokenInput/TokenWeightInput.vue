    ...
    <template v-slot:append>
      <BalStack align="center" horizontal spacing="none">
        ...
        <button
          ...
          :class="[
            'ml-2 ease-color mt-1 text-gray-200 dark:text-gray-300 hover:text-blue-800 dark:hover:text-blue-800 flex items-center shadow-sm border dark:border-0 bg-gray-50 dark:bg-gray-850 rounded-full p-1 justify-center',
            {
        ...
        <button
          @click="emit('delete')"
          :class="[
            'ml-2 ease-color mt-1 text-gray-200 dark:text-gray-300 hover:text-red-500 dark:hover:text-red-500 flex items-center shadow-sm border dark:border-0 bg-gray-50 dark:bg-gray-850 rounded-full p-1 justify-center'
          ]"
        >
