        ...
        >
          <div class="font-semibold flex items-center">
            ...
            <BalIcon
              ...
              name="arrow-up-right"
              size="sm"
              class="ml-1 text-gray-400 dark:text-gray-600 group-hover:text-gold-200 transition-colors"
            />
          </div>
          <div
            class="text-sm text-gray-200 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white transition-colors summary"
          >
            {{ transaction.summary }}
          </div>
        </BalLink>
