<template>
  <div class="lg:container lg:mx-auto pt-10 md:pt-12">
    ...
    <div class="px-4 lg:px-0">
      <h3 class="mb-3">Embr Investment Pools</h3>
      <TokenSearchInput
...
export default defineComponent({
  ...
  setup() {
    ...
    /*const userPoolsWithCembr = computed(() => {
      ...
      if (
        cembrPool &&
        cembrDecoratedFarm.value &&
        cembrDecoratedFarm.value?.share > 0
      ) {
        return [
          {
            ...cembrPool,
            ...
            tokens: [
              {
                address: appNetworkConfig.cEmbr.address,
                balance: '0',
                weight: '1'
              },
              ...cembrPool.tokens
