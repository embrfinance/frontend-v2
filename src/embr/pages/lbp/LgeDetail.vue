...
import LbpTradeCard from '@/embr/lbp/components/TradeCard/LgeTradeCard.vue';
import LbpStatCards from '@/embr/lbp/components/LbpStatCards.vue';
import LbpDetailWarning from '@/embr/lbp/components/LbpDetailWarning.vue';
import LgeChart from '@/embr/lbp/components/LgeChart.vue';
import { useRoute } from 'vue-router';
import useLgeQuery from '@/embr/lbp/composables/useLgeQuery';
import LgeDetailStatusBanner from '@/embr/lbp/components/LgeDetailStatusBanner.vue';
import BalLoadingBlock from '@/components/_global/BalLoadingBlock/BalLoadingBlock.vue';
import useTokens from '@/composables/useTokens';
import { getAddress } from '@ethersproject/address';
import BalTabs from '@/components/_global/BalTabs/BalTabs.vue';
import LgeDetailProjectDetails from '@/embr/lbp/components/LgeDetailProjectDetails.vue';
import Swaps from '@/components/contextual/pages/pool/PoolTransactionsCard/PoolSwaps/Swaps.vue';
import LbpDetailMultisigWarning from '@/embr/lbp/components/LbpDetailMultisigWarning.vue';
import LgeDetailAdmin from '@/embr/lbp/components/LgeDetailAdmin.vue';
...
import LgeSwapsTable from '@/embr/lbp/components/LgeSwapsTable.vue';
      ...
      <div class="order-1 lg:order-2 px-1 lg:px-0">
        <div class="pb-2 pt-20 relative">
          ...
          <template v-else>
            ...
            <!--            <div class="mt-4">
              <img src="~@/embr/assets/images/ludwig-says.svg" />
            </div>-->
          </template>
        </div>
      </div>
